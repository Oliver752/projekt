		...
		<section class="pure-text-centered">
			...
			<section class="text-banner">
				<div class="container text-center">
					...
					<div class="row">
						<div class="col-md-12">
							<a href="process.php" class="btn btn-primary" target="default">See the process</a>
							<a href="wines.php" class="btn btn-primary btn-text-only" target="default">See our wines</a>
						</div>
					</div>
				</div>
			</section>
