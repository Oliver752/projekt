					...
					<ul class="selector-content">
						...
						<li class="clearfix">
							...
							<div class="row">
								<div class="col-sm-6">
									<p class="lead">
										Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem.</p>	
								</div>
						...
						<li class="clearfix">
							<div class="row">
								<div class="col-sm-12 text-center">
									<h1>Enim minima veniam quis nostrum exercitationem ullam corporis</h1>
								</div>
							</div>
						...
						<li class="clearfix">
							<div class="row">
								<div class="col-sm-12 text-center">
									<h1>Duis aute irure dolor reprehenderit voluptate velit cillum</h1>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<p class="lead">
										Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem.
									</p>	
								</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="space-bottom-medium">Check out how we do it</h1>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="media-holder fullwidth-video" src="">
								<iframe width="100%" height="315" src="http://www.youtube.com/embed/4UJmB3EqhU0?showinfo=0&amp;rel=0&amp;modestbranding=1" frameborder="0" allowfullscreen="">
